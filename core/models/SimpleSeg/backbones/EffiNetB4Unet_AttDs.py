...
def create_module(in_channels, out_channels, att_dropout_count):
    module = smp.Unet(
    ...
    stride_conv_modify(module.encoder._conv_stem,8,att_dropout_count*0)
        
    stride_block_modify(module.encoder._blocks[2],att_dropout_count*1/5)
    stride_block_modify(module.encoder._blocks[6],att_dropout_count*2/5)
    stride_block_modify(module.encoder._blocks[10],att_dropout_count*3/5)
    stride_block_modify(module.encoder._blocks[22],att_dropout_count*4/5)
